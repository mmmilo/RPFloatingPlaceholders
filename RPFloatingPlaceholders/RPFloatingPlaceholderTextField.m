...
- (void)drawRect:(CGRect)aRect
{
    ...
    if (_shouldDrawPlaceholder) {
        ...
        CGRect placeholderFrame = CGRectMake(CGRectGetMinX(textRect), floorf((self.frame.size.height - self.font.lineHeight) / 2.f), CGRectGetWidth(textRect), CGRectGetHeight(textRect));
